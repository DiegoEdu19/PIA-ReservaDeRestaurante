...
export const crearReserva = async (req, res) => {
    const { nombre, cantidad_personas, fecha, hora_inicio,telefono, estado_id, id_restaurante } = req.body;
    ...
    try {
        await pool.query(
            ...
            [nombre, cantidad_personas, fecha, hora_inicio, telefono, estado_id, id_restaurante]
        );
